...
conn1 = MySQLdb.connect(host="112.126.74.80", user="root", passwd="Zhaojianghe123", db="zd_company", charset="utf8")
cursor1 = conn1.cursor()
conn2 = MySQLdb.connect(host="101.201.222.72", user="root", passwd="Zhidaoii123", db="9-xiaoyang", charset="utf8")
